                ...
                InputProps={{
                    ...
                    startAdornment: (
                        <InputAdornment position='start'>
                            <IconButton aria-label='alternar a visibilidade da senha' onClick={handleShowPassword} edge='start'>
                    ...
                    endAdornment: (
                        <InputAdornment position='end'>
                            <IconButton aria-label='copiar valor para a área de transferência' onClick={handleCopy} edge='end'>
                                <ContentCopyIcon />
                            </IconButton>
                        </InputAdornment>
                    ),
